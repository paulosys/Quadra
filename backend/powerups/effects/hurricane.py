"""HurricaneEffect — applies a vortex force to all balls near center."""
...
class HurricaneEffect(PowerUpEffect):
    ...
    def apply_to_room(self, bus: "EventBus", collector: int | None) -> None:
        ...
        bus.publish(GameEvent.POWERUP_COLLECTED, effect="hurricane", collector=collector)
